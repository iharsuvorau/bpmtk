...
public class State {
  ...
  public Set<IntIntHashMap> possibleFutures() {
    if (this.possibleFutures == null) this.possibleFutures = new UnifiedSet<>();
  ...
  public Set<IntIntHashMap> loopLabels() {
    if (this.loopLabels == null) this.loopLabels = new UnifiedSet<>();
    return this.loopLabels;
  }

  public IntHashSet loops() {
    if (this.loops == null) this.loops = new IntHashSet();
    return this.loops;
  }
