...
public class AdjacencyList {
   ...
   * @return int[][]-array of the adjacency-list of given nodes. The first dimension in the array
   *     represents the same node as in the given adjacency, the second dimension represents the
   *     indicies of those nodes, that are direct successornodes of the node.
   */
