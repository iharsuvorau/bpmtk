package processmining.accuracy.abstraction;


import static processmining.accuracy.abstraction.subtrace.Subtrace.INIT;

import java.util.Map;
import java.util.StringTokenizer;
import processmining.accuracy.abstraction.markovian.MarkovAbstraction;
import processmining.accuracy.abstraction.markovian.MarkovLabel;
import processmining.accuracy.abstraction.set.SetAbstraction;
import processmining.accuracy.abstraction.set.SetLabel;
import processmining.accuracy.abstraction.subtrace.Subtrace;
import processmining.accuracy.abstraction.subtrace.SubtraceAbstraction;
