...
public class ConfusionMatrix {
  ...
  private final int[]
      movesOnLog; // this array stores the number of move on log for the min cost alignment of a log
                  // trace
  private final int[]
      movesOnModel; // this array stores the number of move on model for the min cost alignment of a
                    // model trace

  private final int[]
      syncMovesModel; // this array stores the number of move on model for the min cost alignment of
                      // a model trace
