...
package au.edu.unimelb.processmining.splitminer.dfgp;

import au.edu.unimelb.processmining.log.ComplexLog;
...
//            System.out.println("DEBUG - AND("+ p.getLeft() + "," + p.getRight() + ")");
            if (relations.containsKey(p) && relations.get(p) != Gate.AND)
                System.out.println("WARNING - double relation for: (" + p.getLeft() + "," + p.getRight() + ")");
