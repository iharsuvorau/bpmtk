...
//		this.removeTauArcs();
    ...
    public void removeTauArcs() {
        ...
        while (!toBeVisited.isEmpty()) {
            ...
            UnifiedSet<de.drscc.automaton.Transition> in = new UnifiedSet<>(state.incomingTransitions());
    ...
    private void replaceTauArc(de.drscc.automaton.Transition tau, de.drscc.automaton.State state, Set<de.drscc.automaton.State> closed) {
        ...
        UnifiedSet<de.drscc.automaton.Transition> out = new UnifiedSet<>(state.outgoingTransitions());
